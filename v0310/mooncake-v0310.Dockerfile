# =============================================================================
# v0310/mooncake-v0310.Dockerfile
# Mooncake v0.3.10 编译环境镜像（openEuler + Ascend 910B，兼容 GCC 10）
#
# 设计要点（区别于新版）：
#  - 只编译 Transfer Engine（cmake 时用 -DWITH_STORE=OFF），绕开 v0.3.10
#    mooncake-store 里 atomic_flag::test() 等 GCC 11 专属特性
#  - v0.3.10 的 Transfer Engine 本身是 GCC 10 兼容的
#  - CANN / NPU 设备运行时从宿主机挂载，不打进镜像
#
# 构建：podman build -t mooncake-v0310:latest -f v0310/mooncake-v0310.Dockerfile .
# =============================================================================
